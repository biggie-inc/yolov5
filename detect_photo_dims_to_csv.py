...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per img
            ...
            dims_to_csv['filename'] = file_name
            ...
            if det is not None and len(det):
                ...
                try:
                    for i, (handle_mid, max_point) in enumerate(zip(handle_mids, handles_ymax)): 
                        ...
                        elif handle_mid[1] > tailgate_ythird_coord[closest_index][1]:
                            dims_to_csv['handle_loc'] = 3
                        else:
                ...
                try: 
                    ...
                    dims_to_csv['btm_h_to_btm_tg'] = 'nan'
